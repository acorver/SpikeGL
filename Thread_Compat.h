...
#ifdef QT_CORE_LIB
// emualte the windows FG_SpikeGL.exe classes so that the above code doesn't depend on Qt
#include <QMutex>
#include <QSemaphore>
#include <QThread>
#ifndef INFINITE_TO
...
public:
    ...
    int id() { return reinterpret_cast<int>(this); }
...
#else
#include "FrameGrabber/FG_SpikeGL/FG_SpikeGL/Thread.h"
#endif
